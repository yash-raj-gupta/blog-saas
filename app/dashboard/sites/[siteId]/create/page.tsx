...
export default function ArticleCreationRoute({params}: {params: {siteId: string}}) {
    ...
    function handleSlugGeneration(){
        ...
        if(titleInput?.length ===0 || titleInput === undefined){
            return toast.error("Please enter a title before generating a slug")
        }
                ...
                <CardContent>
                    <form className="flex flex-col gap-6" id={form.id} onSubmit={form.onSubmit} action={action}>
                        ...
                        <div className="grid gap-2">
                            ...
                            placeholder="Small Description for your blog article..." className="h-32"/>
                    ...
                    <SubmitButton text="Create Article" className="" /> 
                    </form>
                </CardContent>
            </Card>
            </>
